# Autogenerated wrapper script for HelloWorldFortran_jll for x86_64-unknown-freebsd11.1-libgfortran4
export hello_world
...
function __init__()
    ...
    global hello_world_path = abspath(joinpath(artifact"HelloWorldFortran", hello_world_splitpath...))
