# `HelloWorldFortran_jll.jl` (v1.1.1+0)

[![deps](https://juliahub.com/docs/HelloWorldFortran_jll/deps.svg)](https://juliahub.com/ui/Packages/General/HelloWorldFortran_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/4bf0d1759ca671f6defa24f17bd308ea32d3d42a/H/HelloWorldFortran/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
`HelloWorldFortran_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `HelloWorldFortran_jll.jl`:
